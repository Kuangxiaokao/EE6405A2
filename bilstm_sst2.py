...
train_data = LoadDataset('./data/sst2_process/train.parquet')
validation_data = LoadDataset('./data/sst2_process/validation.parquet')
test_data = LoadDataset('./data/sst2_process/test.parquet')

train_texts = train_data['sentence']
train_labels = train_data['label']

validation_texts = validation_data['sentence']
...
model.save('bilstm_sst2.h5')

with open('training_history_sst2.json', 'w') as f:
...
plot_graphs("sst2.png", historyLSTM, "accuracy")